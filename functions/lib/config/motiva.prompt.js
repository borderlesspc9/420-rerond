...
exports.buildMotivaSystemPrompt = buildMotivaSystemPrompt;
exports.buildMotivaAnalysisPrompt = buildMotivaAnalysisPrompt;
exports.isMotivaConcessionaria = isMotivaConcessionaria;
 ...
 */
function buildMotivaSystemPrompt() {
...
function buildMotivaAnalysisPrompt(dados, requisitosFormatados, escopo, promptCustomizado) {
...
function isMotivaConcessionaria(concessionariaId) {
    return concessionariaId === "motiva";
}
//# sourceMappingURL=motiva.prompt.js.map