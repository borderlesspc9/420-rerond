 ...
 */
export function buildArterisSystemPrompt(): string {
...
export function buildArterisAnalysisPrompt(
...
export function isArterisConcessionaria(concessionariaId?: string | null): boolean {
