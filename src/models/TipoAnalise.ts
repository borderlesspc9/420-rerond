...
const REQ_POC: RequisitoTipoAnalise[] = [
  ...
  },
  {
    ...
    descricao: 'Localização (km/sentido) coerente entre formulário, memorial e plantas.',
    categoria: 'GEOMETRIA',
  },
  {
    id: 'POC_COMPAT_MEMORIAL_PLANTAS',
    descricao: 'Compatibilização Memorial × plantas (sem divergência de cotas/km/escopo).',
    categoria: 'TECNICO',
  },
  {
    id: 'POC_ART',
  ...
  },
  {
    ...
    descricao: 'Interferência com faixa de domínio / non aedificandi identificada.',
    categoria: 'GEOMETRIA',
  },
]
...
const REQ_PPU: RequisitoTipoAnalise[] = [
  {
    ...
    descricao: 'Completude documental de publicidade (requerimento, memorial, projeto).',
    categoria: 'DOCUMENTAL',
  },
  {
    id: 'PPU_ESTRUTURA_SUSTENTACAO',
    descricao: 'Estrutura de sustentação do dispositivo de publicidade dimensionada/apresentada.',
    categoria: 'TECNICO',
  },
  {
  ...
  },
  {
    ...
    descricao: 'Avaliação de interferência com segurança viária / visibilidade.',
    categoria: 'SEGURANCA',
  },
  {
    id: 'PPU_ART',
...
const REQ_PAC_VIAB: RequisitoTipoAnalise[] = [
  ...
  {
    id: 'PACV_ESCOPO_FASE',
    descricao: 'Escopo coerente com fase de viabilidade (não exigir disciplinas só de executivo).',
    categoria: 'PLANEJAMENTO',
  },
  {
    id: 'PACV_LOCALIZACAO',
...
const REQ_PAC_EXEC: RequisitoTipoAnalise[] = [
  ...
  {
    id: 'PACE_GEOMETRIA',
    descricao: 'Projeto geométrico / planta compatível com memorial (quando enviados).',
    categoria: 'GEOMETRIA',
  },
  {
  ...
  {
    id: 'PACE_SINALIZACAO',
    descricao: 'Sinalização avaliada se enviada; não exigir se não anexada nesta etapa.',
    categoria: 'SEGURANCA',
  },
  {
    id: 'PACE_ART',
...
export const TIPOS_ANALISE_SEED: TipoAnalise[] = [
  ...
  },
  {
    ...
    slug: 'poc',
    categoria: 'poc',
    descricao: 'Tipologia POC (Projeto de Ocupação) — Ecovias/Capixaba e equivalentes.',
  ...
  },
  {
    ...
    categoria: 'pac',
    descricao: 'PAC na fase de viabilidade — não exigir disciplinas exclusivas de executivo não enviadas.',
  ...
  },
  {
    ...
    slug: 'pac-executivo',
    categoria: 'pac',
    descricao: 'PAC executivo — disciplinas conforme documentos enviados nesta etapa.',
  ...
  },
  {
    ...
    slug: 'ppu',
    categoria: 'ppu',
    descricao: 'Projeto de publicidade (PPU) — critérios próprios, não ocupação genérica.',
